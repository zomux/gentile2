...
if len(sys.argv) == 2:
  ...
  pathTest = "/poisson2/home2/raphael/ntcir10/data.test.full"
...
linesLog = open(pathLog).readlines()
linesLog = [l for l in linesLog if "] loading" not in l]
linesLog = "".join(linesLog).split("\n---\n")[1:]
count = 0
countGlue = 0
